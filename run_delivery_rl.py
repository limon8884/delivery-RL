...
@click.option('--use_dist_feature', required=False, type=bool)
...
@click.option('--coef_reward_completed', required=False, type=float)
@click.option('--coef_reward_assigned', required=False, type=float)
@click.option('--coef_reward_cancelled', required=False, type=float)
@click.option('--coef_reward_distance', required=False, type=float)
