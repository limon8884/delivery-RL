...
class GambleTripleEncoder(nn.Module):
    ...
    def forward(self, gamble_triple: GambleTriple, current_time: int):
        ...
        '''
        o_tensor, o_ids = self.make_tensor_with_ids(gamble_triple.orders, item_type='o',
                                                    current_time=current_time)
        c_tensor, c_ids = self.make_tensor_with_ids(gamble_triple.couriers, item_type='c',
                                                    current_time=current_time)
        ar_tensor, ar_ids = self.make_tensor_with_ids(gamble_triple.active_routes, item_type='ar',
                                                      current_time=current_time)
